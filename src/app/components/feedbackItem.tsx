...
export default function FeedbackItem({text, name} : cartProps) {
    return (
        <div className="bg-white/60 backdrop-blur-md rounded-2xl py-8 px-6 shadow-md border border-white/40 transition-all hover:shadow-xl hover:scale-[1.01] duration-300 my-10 md:mx-0 mx-2 min-h-[220px]">
