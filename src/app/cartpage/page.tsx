    ...
    return (
        <div>
            ...
            {cartItems.length === 0 ? <div className="text-center mt-8 py-10">
                ...
                <Link href={'/mainStore'} className="w-96 mx-auto flex justify-center text-white py-[13px] px-6 rounded-full ease-out duration-200 bg-slate-800 hover:opacity-90">ادامه خرید</Link>
